...
function transactionFeeInput() {
    const fixedFee = document.getElementById('fixedFeeSection');
...
$('#submitButton').click(function () {
    ...
    if (purchaseAmount == '' || rewardsRate == '' || transactionFeeFixed == '') {
        ...
        $dollarsProfit.html(rewardsRate * purchaseAmount);
        $dollarsFee.html(transactionFeeFixed);
        $dollarsNet.html(earnedRewards - transactionFeeFixed);
